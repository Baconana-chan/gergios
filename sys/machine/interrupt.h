/*	$NetBSD$	*/
/* Interrupt handling — multi-architecture constants.
 *
 * For x86 (x86_64, i386): 8259 PIC ports, IRQ vectors, hardware vectors.
 *   These match minix/include/arch/x86_64/include/interrupt.h.
 *
 * For AArch64: minimal stub — GIC constants defined by board/SoC.
 */
...
#else
/* AArch64 (and other non-x86): minimal stub.
 * NR_IRQ_VECTORS for GICv3 (256 SPIs + 32 PPIs + 16 SGIs).
 */
