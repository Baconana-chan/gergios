/* Limine Boot Protocol definitions for GergiOS.
 *
 * This is a minimum set of Limine protocol structures needed for
 * booting the kernel. Based on the Limine Boot Protocol v8.x.
 *
 ...
 * (or ".requests" for newer revisions) so the bootloader can find them.
 */
 ...
 * =========================================================================
 * The kernel must declare LIMINE_BASE_REVISION(N) to tell the bootloader
 * which protocol revision it supports. Revision 1 is recommended.
 */
...
#define LIMINE_SMP_X2APIC  0
#define LIMINE_SMP_XAPIC   1
...
/* =========================================================================
 * DTB (Device Tree Blob - for ARM / RISC-V)
 * =========================================================================
 */
