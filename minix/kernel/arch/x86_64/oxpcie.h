/* OXPCIe952 serial port definitions for x86_64.
 * Ported from: minix/kernel/arch/i386/oxpcie.h
 *
 * The OXPCIe952 is a PCIe serial port controller.
 * MMIO registers are accessed via oxpcie_vaddr (set by oxpcie_set_vaddr).
 */

#ifndef _X86_64_OXPCIE_H_
#define _X86_64_OXPCIE_H_
