/* x86_64 ACPI structures — ported from i386.
 * ACPI data structures are architecture-independent for x86.
 */

#ifndef __X86_64_ACPI_H__
#define __X86_64_ACPI_H__
